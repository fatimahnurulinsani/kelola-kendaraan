	...
	*/
	...
	function index(){
		...
		$data = array(
			...
			'title' => 'Dashboard - PT. Marion Sam'
		);
		$this->load->view('webadmin/index',$data);
	}
	
	function login($mess = 1){
		$this->load->view('webadmin/login',array('message' => $mess,'title' => 'Login - PT. Marion Sam'));
	}
	...
	function proseslogin(){		
		if($_POST){
			...
			$this->load->view('webadmin/pagenotfound',array('title' => 'Dashboard - PT. Marion Sam'));
		}
	}
	...
	function newcontent(){
		...
		$data = array(
			...
			'tags' => '',
			'isi' => '',
			'title' => 'Tulis Berita - PT. Marion Sam'
		);
	...
	function editcontent($kode = 0){
		...
		$data = array(
			...
			'title' => 'Edit Content - PT. Marion Sam'
		);
		$this->load->view('webadmin/editor',$data);
	}
	...
	function content($mess = -1){
		...
		$data = array(			
			...
			'message' => $mess,
			'title' => 'Daftar Berita - PT. Marion Sam'
		);
	...
	function contentpublish($mess = -1){
		...
		$data = array(
			...
			'message' => $mess,
			'title' => 'Daftar Publish - PT. Marion Sam'
		);
		$this->load->view('webadmin/post',$data);
	}
	...
	function contentdraft($mess = -1){
		...
		$data = array(
			...
			'message' => $mess,
			'title' => 'Daftar Draft - PT. Marion Sam'
		);
		$this->load->view('webadmin/post',$data);
	}	
	...
	function pages($pages = NULL){
		...
		if($pages != NULL){
			...
			$data = array(
				'session' => $this->session->userdata('login'),
				'username' => $data_sess['pengguna'],
				'id_pages' => $data_pages[0]['id_pages'],
				'pages' => $data_pages[0]['pages'],
				'feature_image' => $data_pages[0]['feature_image'],		
				'content' => $data_pages[0]['content'],
				'deskripsi' => $data_pages[0]['deskripsi'],
				'title' => $pages.' - PT. Marion Sam'
			);
			$this->load->view('webadmin/pages',$data);
		}else{
			header("location: ".base_url()."index.php/webadmin/");
		}
	}

	function savepages($pages = NULL){
		$this->cek_session();
		if($_POST){
			$data_sess = $this->session->userdata('login');
			$pages = $_POST['pages'];
			...
			$content = $_POST['content'];
				...
				$this->blog_model->UpdateData('pages',$data,array('pages' => $pages));

				header('location:'.base_url().'index.php/webadmin/pages/'.$pages);
		}else{
			$this->load->view('webadmin/pagenotfound',array('title' => 'page not found'));
		}
	}	
...
// ############################################ PRODUCT ################################################################
	...
	function product($mess = -1){

		$this->cek_session();
		$data = array(			
			'session' => $this->session->userdata('login'),
			'content' => $this->blog_model->GetProduct('order by product desc')->result_array(),
			'message' => $mess,
			'title' => 'Daftar Product - PT. Marion Sam'
		);
		$this->load->view('webadmin/product',$data);
	}
	...
	function newproduct(){
		...
		$data = array(
			...
			'deskripsi' => '',
			'status' => 'baru',
			'title' => 'Product Baru - PT. Marion Sam'
		);

		$this->load->view('webadmin/newproduct',$data);
	}
	...
	function editproduct($id = 0){
		...
		$data = array(
			'session' => $this->session->userdata('login'),
			'username' => $data_sess['pengguna'],
			'id_product' => $data_content[0]['id_product'],
			'product' => $data_content[0]['product'],
			'images1' => $data_content[0]['images1'],
			'images2' => $data_content[0]['images2'],
			'images3' => $data_content[0]['images3'],
			'images4' => $data_content[0]['images4'],		
			'deskripsi' => $data_content[0]['deskripsi'],
			'status' => 'lama',
			'content' => $data_content[0]['content'],
			'title' => 'Edit Product - PT. Marion Sam'
		);
	...
	function saveproduct(){
		...
		if($_POST){
			...
			$this->blog_model->InsertData('product',$data);

			header('location:'.base_url().'index.php/webadmin/product/1');
			...
			$this->blog_model->UpdateData('product',$data,array('id_product' => $id_product));

			header('location:'.base_url().'index.php/webadmin/product/2');
	...
	function deleteproduct($id = 0){
		$this->cek_session();
		$result = $this->blog_model->DeleteData('product',array('id_product' => $id));
		
		if($result == 1){
			header('location:'.base_url().'index.php/webadmin/product/1');
		}else{
			header('location:'.base_url().'index.php/webadmin/product/0');
		}
	}
...
// HOME SLIDER IMAGES
	...
	function slider($mess = -1){

		$this->cek_session();
		$data = array(			
			'session' => $this->session->userdata('login'),
			'content' => $this->blog_model->GetSlider('order by id asc')->result_array(),
			'message' => $mess,
			'title' => 'Daftar Slider - PT. Marion Sam'
		);
	...
	function saveslider(){
		...
		if($_POST){
			...
			$this->blog_model->InsertData('slider',$data);
			header('location:'.base_url().'index.php/webadmin/slider/1');
	...
	function deleteslider($id = 0){
		$this->cek_session();
		$result = $this->blog_model->DeleteData('slider',array('id' => $id));
		
		if($result == 1){
			header('location:'.base_url().'index.php/webadmin/slider/1');
		}else{
			header('location:'.base_url().'index.php/webadmin/slider/0');
		}
	}
	...
	function labels($mess = -1){
		...
		$data = array(
			...
			'title' => 'Daftar Label - PT. Marion Sam'
		);
	...
	function editlabel($kode = 0){
		...
		$data = array(
			...
			'title' => 'Edit Label - PT. Marion Sam'
		);
		$this->load->view('webadmin/label',$data);
	}
	...
	function users($mess = -1){
		...
		$data = array(
			...
			'title' => 'Daftar User - PT. Marion Sam'
		);
	...
	function listcomment($mess = -1){
		...
		$data = array(
			...
			'title' => 'Daftar Komentar - PT. Marion Sam'
		);
	...
	function replycomment($kode = 0){
		...
		$data = array(
			...
			'session' => $this->session->userdata('login'),
			'title' => 'Balas Komentar - PT. Marion Sam'
		);
	...
	function settingdasar($mess = -1){
		...
		$data = array(
			...
			'title' => 'Setting Dasar - PT. Marion Sam'
		);	
	...
	function settingprofile($mess = -1){
		...
		$data = array(
			...
			'message' => $mess,
			'title' => 'Setting Profile - PT. Marion Sam'
		);
	...
	function settingpassword($mess = -1){
		...
		$data = array(
			...
			'username' => $data_sess['username'],
			'message' => $mess,
			'title' => 'Setting Password - PT. Marion Sam'
		);
